...
class A {
  ...
  void fun() {
    ...
    boolean b = !Pattern.matches(".*<script>.*", htmlString);// Noncompliant, even if the pattern is hard-coded
  }
...
public class Test implements Serializable {
  ...
  @javax.validation.constraints.Pattern(regexp = "arg")
  ...
  @javax.validation.constraints.Email(message = "yabadabadoo") // compliant no regexp
