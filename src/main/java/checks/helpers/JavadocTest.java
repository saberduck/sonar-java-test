...
class A<B, C, E> {
   ...
   */
  private int foo(int a, int c, int d, int e) throws NullPointerException, IOException, IllegalStateException, B {
    return 0;
  }
   ...
   * @param e FIXME
   */
  private int emptyDescription(int a, int b, int c, int d, int e) throws NullPointerException {
    return 0;
  }
   ...
   * @param d d
   * @param e e
   * @throws NullPointerException exception with fully qualified name
   */
