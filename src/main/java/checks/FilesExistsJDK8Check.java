...
class A {
  ...
  java.util.function.Predicate<Path> p1 = f -> Files.isRegularFile(f); // Noncompliant
  java.util.function.Predicate<Path> p2 = Files::isRegularFile; // Noncompliant [[sc=64;ec=77]]
}
