...
class A implements Supplier<Integer> { // Noncompliant [[sc=7;ec=8]] {{Refactor this code to use the more specialised Functional Interface 'IntSupplier'}}
  ...
  private class AA implements Consumer<Long> { // Noncompliant
    ...
    BiConsumer<AA, Double> a14 = (aaa, double1) -> {};; // Noncompliant {{Refactor this code to use the more specialised Functional Interface 'ObjDoubleConsumer<AA>'}}
    ...
    Function<AA, AA> a39; // Compliant -- compliant no initialization
    ...
    Function<Entry<?, AA>,? extends A> a32 = new Function() { // Compliant
      @Override
      public Object apply(Object t) {
        return null;
      }
    ...
    private class A3{}
    Function<A3, A3> foo1 = a3 -> new A3(); // Noncompliant {{Refactor this code to use the more specialised Functional Interface 'UnaryOperator<A3>'}}
  }

  Function<AA, AA> foo1 = aaaaaa -> new AA(); // Noncompliant {{Refactor this code to use the more specialised Functional Interface 'UnaryOperator<AA>'}}
}
