...
class A {
  void myMethod(byte[] bytes, File file, OutputStream outputStream) {
    ...
    new Scanner(new java.io.FileInputStream("")); // Noncompliant
    FileReader reader = null; // Noncompliant
    FileReader reader3 = new FileReader(""); // Noncompliant
    Reader reader2 = fileReader(); // Noncompliant [[sc=30;ec=40]]
    FileWriter writer = null; // Noncompliant
    Writer writer2 = fileWriter(); // Noncompliant
