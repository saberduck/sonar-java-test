...
class Outer {
  ...
  class C {
    ...
    java.lang.Class fun() { return null;}
...
class CastToRawType {
  void fun() {
    ...
    java.lang.Class o2  = (java.lang.Class) Object[].class; // Noncompliant
  }
  private final Map<java.lang.Class<?>, Index<?,?,?>> indexComponents;
  public <K extends Index> K get(java.lang.Class<K> clazz){
...
class G<T> {
  ...
  class H {
    ...
    public <T> T getInstance(Ruby runtime, Object o, java.lang.Class<T> clazz) {
      String name = clazz.getName();
      java.lang.Class<T> c = (java.lang.Class<T>) java.lang.Class.forName(name, true, o.getClass().getClassLoader());
    }
