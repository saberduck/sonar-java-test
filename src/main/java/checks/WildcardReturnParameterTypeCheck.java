...
class Animal {
  ...
  class InnerDog extends Animal {
   ...
   public List<java.lang.Class<?>> foo() {} // Compliant Class is ignored
   public List<? extends java.lang.Class<String>> bar() {} // Noncompliant {{Remove usage of generic wildcard type.}}
